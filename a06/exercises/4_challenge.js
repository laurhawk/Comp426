...
export async function getTwoHeroesSolution(heroData, hero1Id, hero2Id) {
  ...
  let heroOne = heroData.find(hero=>hero.id=hero1Id)
  let heroTwo = heroData.find(hero=>hero.id=hero2Id)
  setTimeout(() => resolve(heroOne, heroTwo), 1500);
}));
  heroOne = getTwoHeroes(heroData, hero1Id, hero2Id)
}
